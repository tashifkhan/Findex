...
from app.core import BACKEND_HOST, BACKEND_PORT, get_logger
from app.models import YTVideoInfo
from app.youtube_utils import extract_video_id, get_video_info, get_subtitle_content
...
def health():
    return jsonify(
        {
            "status": "healthy",
            "message": "Findex Backend is running",
        }
    )
