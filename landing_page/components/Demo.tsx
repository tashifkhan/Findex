  ...
  const demos = [
    {
      ...
      description: "Watch how FindexAI understands context and provides intelligent answers instead of just keyword matches.",
      thumbnail: "/demo-semantic.png",
      gifUrl: "/demo-semantic.gif"
    },
    {
      title: "YouTube Transcript Search",
      description: "Search through YouTube video content using natural language queries to find specific moments.",
      thumbnail: "/demo-youtube.png", 
      gifUrl: "/demo-youtube.gif"
    },
    {
      title: "Multi-Agent Web Search",
      description: "See how multiple AI agents work together to search the web and provide comprehensive answers.",
      thumbnail: "/demo-websearch.png",
      gifUrl: "/demo-websearch.gif"
    },
    {
      title: "Custom LLM Integration",
      description: "Configure your own API keys and choose between different language models for personalized results.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Experience the power of AI-driven search with these interactive demos
          </p>
        </div>
          ...
          <div className="relative bg-gray-800 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="relative aspect-video bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center">
              ...
              <div className="text-center p-8">
                ...
                <h3 className="text-2xl font-bold mb-4">{demos[currentDemo].title}</h3>
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-semibold text-lg">{demos[currentDemo].title}</h4>
                  <p className="text-gray-300 text-sm">{demos[currentDemo].description}</p>
                </div>
