	...
	return (
		...
		>
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				{/* Sidebar */}
				<div
					className={`fixed top-0 left-0 h-full bg-gray-900/95 backdrop-blur-sm z-40 transition-all duration-300 lg:bg-gray-800/30 lg:backdrop-blur-md lg:border-r lg:border-gray-700/50 ${
						// Mobile behavior
				...
				>
					...
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-300 max-w-3xl mx-auto">
							Complete guide to installing, configuring, and using FindexAI -
							the AI-powered browser extension for intelligent search and
							discovery.
						</p>
					</div>
					...
					>
						...
						<div className="grid md:grid-cols-2 gap-6">
							...
							<div>
								...
								<p className="text-gray-300 mb-4">
									Clone the repository and start the backend service with
									Docker.
								</p>
					...
					>
						...
						<p className="text-gray-300 mb-6">
							FindexAI transforms the traditional &quot;Ctrl+F&quot; search into
							a semantic, multi-agent, and vector-based discovery engine.
							Whether you&apos;re searching through long articles, YouTube
							videos, or live web content, FindexAI leverages advanced language
							models, vector search, and a modular architecture to help you find
							information faster and more intelligently.
						</p>
						...
						<div className="grid md:grid-cols-3 gap-6 mt-8">
							<div className="text-center">
								...
								<p className="text-gray-300">
									Semantic search across web pages, YouTube videos, and
									documents
								</p>
							</div>
							<div className="text-center">
					...
					>
						...
						<div className="mb-8">
							<div className="bg-gray-900 p-6 rounded-lg font-mono text-sm">
								...
								<div className="space-y-2 text-gray-300">
									<div>
										Browser Extension (React) → API Calls → Backend API
										(FastAPI)
									</div>
									<div>
						...
						<div className="grid md:grid-cols-2 gap-8">
							<div>
								...
								<ul className="space-y-2 text-gray-300">
									<li>
										• <strong>FastAPI:</strong> Orchestrates agentic workflows
										and vector DB lookups
									</li>
									<li>
					...
					>
						...
						<div className="mb-8">
							...
							<p className="text-gray-300 mb-4">
								All API endpoints accept JSON payloads and return JSON
								responses. The API uses standard HTTP status codes for
								responses.
							</p>
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-blue-100">
										AI-powered browser extension for semantic search and
										discovery
									</p>
								</div>
						...
						<div className="grid md:grid-cols-2 gap-6">
							<div>
								...
								<ul className="space-y-2 text-gray-300">
									...
									<li>
										• <code className="text-blue-400">/extension</code> -
