		...
		<div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
			<div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
				...
				<p className="text-gray-600 mb-6">
					The FindexAI Firefox extension is currently under development. Join
					our beta list to be notified when it's ready!
				</p>

				<div className="space-y-4">
					<a
						href="/"
						className="block w-full bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg font-medium transition-colors"
					>
						Back to Home
					</a>
