            ...
            function renderMessages() {
                ...
                if (messages.length === 0) {
                    ...
                    welcomeDiv.innerHTML = `
                        ...
                        <h3 style="margin: 0 0 8px 0; font-weight: 600; font-size: 18px;">Ask about this anything</h3>
